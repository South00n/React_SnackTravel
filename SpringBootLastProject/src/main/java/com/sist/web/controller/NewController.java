...
public class NewController {
	...
	public List<NewsVO> news_aop() {
		List<NewsVO> list = mgr.newsListData("과자");
	...
	@GetMapping("news/news_footer_react")
	public List<NewsVO> news_Footerlist(String title) {
		List<NewsVO> list = mgr.newsFooterData(title);
		return list;
	}
}
