...
function SnackList3(){
    ...
    useEffect(()=>{
        axios.get("http://localhost/snack/snack3_list_react",{
            params:{
                page:curpage
            }
        }).then(response=>{
    ...
    useEffect(()=>{
        axios.get("http://localhost/snack/snack3_page_react",{
            params:{
                page:curpage
            }
        }).then(response=>{
            ...
            <div className="wrapper gradient">
                <div className="hoc container clear">
                    <div className="sectiontitle">
                        ...
                        <h6 className="heading font-x2">인스턴트</h6>
                    </div>
                </div>
            </div>
